...
> {
  ...
  ChangeCheckboxValue = async (
    ...
    var Checking = Model.GroupMembers.find(i => i == SelectedMemberID);
  ...
  DeleteGroupMember = async () => {
    ...
    axios
      .post(`https://${Model.URL}/api/user/addmember`, GroupMemberDeleteRequest, {
        headers: Headers,
      })
      .then(res => {
        console.log('Groupresponse: ', res.data);
                  ...
                  <Body>
                    <View
                      ...
                      <CheckBox
                        ...
                        color="green"
                        onPress={() => this.ChangeCheckboxValue(i, i.lId)}
                        style={{
                          height: 15,
                          width: 15,
                          justifyContent: 'center',
