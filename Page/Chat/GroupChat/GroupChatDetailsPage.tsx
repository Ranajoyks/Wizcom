...
export class GroupChatDetailsPageViewModel { }

export default class GroupChatDetailsPage extends BaseComponent<"GroupChatDetailsPage2", GroupChatDetailsPageViewModel> {
  constructor(props: any) {
    super(props);
    this.state = new BaseState(new GroupChatDetailsPageViewModel());
  }
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.navigate("OneToOneChatPage2", { SecondUser: {} as User, OnUserListRefresRequest: this.LoadNewMessages })
            }}>
