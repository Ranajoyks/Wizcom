...
export class NotificationDetailsPageViewModel {
  Message: string = '';
...
var TodayDate = '';
var prdt = false;
export class NotificationDetailsPage extends BaseComponent<
  "NotificationDetailsPage",
  NotificationDetailsPageViewModel
> {
  constructor(props: BaseProps<"NotificationDetailsPage">) {
    super(props);
    this.state = new BaseState(new NotificationDetailsPageViewModel());
    this.state.Model.User = this.props.route.params.User;
  ...
  async componentDidMount() {
    ...
    Model.sender = UserDetails?.userName;
    this.UpdateViewModel();
...
var connector = connect(null, mapDispatchToProps)(NotificationDetailsPage);
