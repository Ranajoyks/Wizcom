...
import { View, StatusBar, ActivityIndicator, ImageBackground,StyleSheet, Text } from 'react-native';
...
export default class Splash extends Component<any, any>{
    ...
    render() {
        return (
          <LinearGradient colors={['#011024', '#002252', '#0248A8']} style={styles.gradientContainer}>
            <View >
            ...
            <View style={{ alignSelf: 'center', marginTop: 20,justifyContent:'center' }}>
